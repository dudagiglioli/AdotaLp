alter table cidade add constraint FK_estado_cidade foreign key(id) references estado(id);
alter table adotantedoador add constraint FK_cidade_adotantedoador foreign key(id) references cidade(id);
...
insert into estado(id, nomeestado, uf, ibge, pais, ddd) values  (1, 'Acre', 'AC', 12, 1, '68'),
...
insert into cidade(id, nome, uf, ibge) values (1, 'Afonso Cláudio', 8, 3200102),
